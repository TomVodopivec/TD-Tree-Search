...
void Player_AI_RL::ResetNode(HashTree::TreeNode* newNode, double initialValue)
{
  ...
  newNode->data->maxBranchQval = -DBL_MAX;  //10.8.2016: changed from =initialValue; (no difference really since every node has a child that has an initialValue at the very beginning)
  newNode->data->minBranchQval = DBL_MAX; //10.8.2016: changed from =initialValue; (no difference really since every node has a child that has an initialValue at the very beginning)
  newNode->data->maxChildQval = -DBL_MAX; //10.8.2016: changed from =initialValue; (no difference really since every node has a child that has an initialValue at the very beginning)
  newNode->data->minChildQval = DBL_MAX;  //10.8.2016: changed from =initialValue; (no difference really since every node has a child that has an initialValue at the very beginning)
...
void Player_AI_RL::UpdateTrajectoryBounds()
{
  ...
  bool maxQval_valid = false;
  bool minQval_valid = false;
