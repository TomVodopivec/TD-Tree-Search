...
#define	TOMPLAYER_AI_UCT_TOMTEST_FUNC_APPROX_NUM_INPUTS		5	//set number of weights for the function approximator or (if dual-layer perceptron) number of inputs in the net
...
#define TOMPLAYER_AI_UCT_TOMTEST_FUNC_APPROX_NEURAL_FUNC	TOMPLAYER_AI_UCT_TOMTEST_NN_FUNCTION_TYPES_SIGMOID_CENTER_ZERO	//neuron threshold function: see below at "enum" for a list of possible functions
...
enum TOMPLAYER_AI_UCT_TOMTEST_NN_FUNCTION_TYPES {
	TOMPLAYER_AI_UCT_TOMTEST_NN_FUNCTION_TYPES_SIGMOID_CENTER_ZERO,
	TOMPLAYER_AI_UCT_TOMTEST_NN_FUNCTION_TYPES_SIGMOID,
	TOMPLAYER_AI_UCT_TOMTEST_NN_FUNCTION_TYPES_STEP,
	TOMPLAYER_AI_UCT_TOMTEST_NN_FUNCTION_TYPES_LINEAR
};
