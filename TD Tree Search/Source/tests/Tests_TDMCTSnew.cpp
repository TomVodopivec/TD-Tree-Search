...
namespace Tests_TDMCTSnew
{
  ...
  void main()
  {
    ...
    Game_Engine* hex11 = new Game_Hex(); hex11->board_length = 11; hex7->board_height = 11; hex11->Settings_Apply_Changes();

    //Tests_TDMCTSnew::Experiment5_perStep_BatchUCB(1, 1000, hex7, 2000, NULL, NULL);
    //Tests_TDMCTSnew::Experiment5_perStep_BatchUCB(2, 1000, hex7, 2000, 0.25, NULL);
